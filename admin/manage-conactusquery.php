...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_REQUEST['eid'])) {
        $eid = intval($_GET['eid']);
        $status = "R";
        $sql = "UPDATE contactus SET queryAction='R' WHERE  Id=$eid";
        $query = $dbh->prepare($sql);
        $query->bindParam("R", $status, PDO::PARAM_STR);
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($result->conEmail); ?></td>
                                                            <td><?php echo htmlentities($result->conMobile); ?></td>
                                                            <td><?php echo htmlentities($result->conMessage); ?></td>
                                                            <td><?php echo htmlentities($result->queryDate); ?></td>
                                                            
                                                            <?php
                                                            if ($result->queryAction == "R") {
                                                                ?><td>Read<br />
