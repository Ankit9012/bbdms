...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = 1;
        $sql = "INSERT INTO  blooddonor(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
        ...
        <body>
            ...
            <div class="ts-main-content">
                ...
                <div class="content-wrapper">
                    <span class="display-3">First Name</span>
